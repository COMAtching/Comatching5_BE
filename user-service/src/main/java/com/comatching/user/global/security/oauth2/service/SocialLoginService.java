package com.comatching.user.global.security.oauth2.service;
...
import com.comatching.user.global.security.oauth2.factory.OAuth2UserInfoFactory;
...
public class SocialLoginService {
	...
	public CustomOAuth2User processUser(ClientRegistration clientRegistration, OAuth2User oAuth2User) {
		...
		// Member Service 호출 (로컬 메서드 호출로 변경)
		MemberLoginDto memberDto = memberService.socialLogin(loginRequest);
