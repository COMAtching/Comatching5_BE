...
public enum MemberErrorCode implements ErrorCode {
	...
	INVALID_HOBBY_COUNT("MEM-006", HttpStatus.BAD_REQUEST, "취미는 최소 1개 이상 최대 5개 이하를 등록해야 합니다."),
	INTRO_LIMIT_EXCEEDED("MEM-006", HttpStatus.BAD_REQUEST, "소개 항목이 최대 갯수(3개)를 초과했습니다."),
	;
